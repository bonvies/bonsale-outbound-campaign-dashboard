...
export default function useTemporaryDisable<T extends string | number | symbol = string>(defaultTimeout = 1000) {
  ...
  const triggerDisable = useCallback((key: T, timeout?: number) => {
